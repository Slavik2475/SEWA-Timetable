  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-black/30 backdrop-blur-lg rounded-xl shadow-lg p-6 mb-8">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4 mb-6">
            <div className="relative">
              ...
              <input
                type="text"
                placeholder="Search..."
                className="w-full pl-10 pr-4 py-2 rounded-lg bg-white/10 border border-white/20 text-white placeholder-gray-300 focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                value={searchText}
            ...
            <select
              ...
              className="rounded-lg bg-white/10 border border-white/20 px-4 py-2 text-white"
            >
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-white/10">
                {filteredData.map((entry, index) => (
                  <tr
                    key={index}
                    className="text-white hover:bg-white/5 transition-colors duration-150"
                  >
